...
| `transparency`| number                                                                 | `0`         | changes opacity    | `0`-`100` where `0` means image is completely visible |
| `shadow`      | [ShadowProps](/PptxGenJS/docs/types#shadow-props-shadowprops)          | `undefined` | shadow props       | (See type link) |
